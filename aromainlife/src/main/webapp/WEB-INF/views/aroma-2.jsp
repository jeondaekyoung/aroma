    ...
    <div class="detail-01">
      ...
      <div class="row tab-menu">
        <div class="col-12 prefix-2 suffix-2 text-center">
          ...
          <div class="fl w20"><a href="aroma-2.jsp" class="tab active">에센셜오일</a></div>
          <div class="fl w20"><a href="aroma-3.jsp" class="tab">캐리어오일</a></div>
          <div class="fl w20"><a href="aroma-4.jsp" class="tab">플로럴워터</a></div>
          <div class="fl w20"><a href="aroma-5.jsp" class="tab">활용방법</a></div> -->
      ...
      <div class="row">
        <div class="col-12 prefix-2 suffix-2 aroma">
          <div class="col-3 prefix-3"><img src="images/aroma/img1.gif" width="100%" alt="식물의 에너지"></div>
        ...
        <div class="col-12 prefix-2 suffix-2 aroma">
          <div class="col-8 compare">
            ...
            <div class="col-16">
              <img src="images/aroma/img02.gif" alt="신경계-뿌리, 생식기·소화기-꽃, 호흡기=잎, 순환기-줄기">
            </div>            
          ...
          <div class="col-8 compare">
            ...
            <div class="col-16">
              <img src="images/aroma/img03.gif" alt="열매: 해독, 잎: 호흡기 강화, 껍질: 기분전환, 수지줄기: 상처 치유, 꽃: 호르몬 조절, 나무줄기: 근골격 강화, 뿌리: 원기 회복" style="height: 100%">
            </div>
          </div>
        </div>
        ...
        <div class="col-12 prefix-2 suffix-2 aroma">
          ...
          <div class="col-5"><img src="images/aroma/img04.gif" width="100%" alt="수증기 증류법"></div>
          ...
          <div class="col-6"><img src="images/aroma/img05.gif" width="100%" alt="용매추출법"></div>
...
이 방법은 모든 공정을 저온에서 할 수 있으므로 열에 매우 약한 에센스 성분을 파괴시키지 않고 그대로 추출할 수 있는 장점이 있다. 또한 기존의 용매 대신 쉽게 기체로 변하는 초임계 이산화탄소를 사용하기 때문에 잔류 용매를 거의 남기지 않으며 짧은 시간안에 추출할 수 있어 오일의 질은 매우 우수하다. 하지만 고압이 필요하기 때문에 이에맞는 고가의 장비가 있어야 한다.</p>
          ...
          <div class="col-4"><img src="images/aroma/img06.gif" width="100%" alt="냉침법"></div>
	    </div>
          
        <div class="col-12 prefix-2 suffix-2 aroma">
          <h3 class="nanumpen">3. 작용원리 (에센셜 오일의 인체 메커니즘)</h3>
          <div class="col-6"><img src="images/aroma/img07.gif" width="100%" alt="후각을 통한 흡수"></div>
          <div class="col-10">
          ...
          <div class="col-4 prefix-1 suffix-1" style="margin-top: 3em"><img src="images/aroma/img08.gif" width="100%" style="padding: 1em 3em" alt="폐를 통한 흡수"></div>
          ...
          <div class="col-4 prefix-1 suffix-1"><img src="images/aroma/img09.gif" width="100%" alt="피부를 통한 흡수"></div>
