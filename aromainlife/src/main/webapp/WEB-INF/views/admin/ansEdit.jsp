			...
			<section id="content">
				<section class="vbox">
					...
					<section class="scrollable wrapper w-f">
						<form action="<c:url value='/qna/ans_edit.do' />" method="post" id="adForm" name="adForm" class="form-horizontal" >
							...
							<input type="hidden" name="ansNo" value="${ans.ansNo }" class="form-control" >
