          ...
          <section class="scrollable wrapper w-f">
            ...
            <input type="hidden" name="contextPath" value='<c:url value="/gal"/>' class="form-control" >
              ...
              <tr>
                ...
                <td></td><!-- 파일이름 -->
                <td></td><!-- 작성일 -->
                <td><button type="button" onclick="eclick('new','',1)"  class="btn btn-info"><i class="fa fa-pencil"></i>등록</button></td>
              </tr>
              <c:choose>
                  ...
                  <c:otherwise>
                    ...
                    <!-- //디폴트 (데이터 유무 상관없이): 이미지 등록은 한 페이지 내에서 한다. -->
                      ...
                      <tr>
                        ...
                        <td>
	                        <button type="button" onclick="eclick('mod','${list.galNo}',1)" class="btn btn-info"><i class="fa fa-edit"></i> 수정</button>
	                        <button type="button" onclick="eclick('del','${list.galNo}',1)" class="btn btn-danger"><i class="fa fa-minus-circle"></i> 삭제</button>
                        </td>
                      </tr>                             
                    </c:forEach>
                  </c:otherwise>
