    ...
    <div class="detail-01">
      ...
      <div class="row">          
        <div class="col-12 prefix-2 suffix-2 col-m-14 prefix-m-1 suffix-m-1 aroma aroma-5">
          ...
          <div class="col-3 col-sm-6"><img src="<c:url value='/resources/images/aroma/img30.gif'/>" width="100%" alt="아로마 디퓨저"></div>
          ...
          <div class="col-3 col-sm-6"><img src="<c:url value='/resources/images/aroma/img31.gif'/>" width="100%" alt="아로마 가습기"></div>
          ...
          <div class="col-3 col-sm-6"><img src="<c:url value='/resources/images/aroma/img32.gif'/>" width="100%" alt="페이셜 스팀, 흡입법"></div>
          <div class="col-13 col-sm-16">
          ...
          <div class="col-3 col-sm-6"><img src="<c:url value='/resources/images/aroma/img33.gif'/>" width="100%" alt="전신욕"></div>
          <div class="col-13 col-sm-16">
...
단, 감귤류의 오일(레몬, 오렌지, 버가못 등)은 향으로는 좋지만 직접 피부에 닿았을 때 자극이 될 수 있으므로 적은 양을 사용하거나 천일염 또는 캐리어오일, 보드카, 우유 등에 희석해서 사용하는 것이 좋다. 휴식하기 위해서는 따뜻한 물(35~38도)로, 기분전환이나 원기회복에는 뜨거운 물(40도 정도)로 입욕하는 것이 좋다. 민감성 피부인 사람은 오일을 직접 넣지않고 천일염, 캐리어오일, 우유등에 희석해서 사용하는 것이 좋다.</p>
          ...
          <div class="col-3 col-sm-6"><img src="<c:url value='/resources/images/aroma/img34.gif'/>" width="100%" alt="반신욕"></div>
          <div class="col-13 col-sm-16">
          ...
          <div class="row">
              <div class="col-3 col-sm-6"><img src="<c:url value='/resources/images/aroma/img36.gif'/>" width="100%" alt="수욕" style="padding: 0 3em"></div>
              <div class="col-13 col-sm-16">
          ...
          <div class="col-3 col-sm-6"><img src="<c:url value='/resources/images/aroma/img37.gif'/>" width="100%" alt="팔꿈치욕"></div>
          <div class="col-13 col-sm-16">
          ...
          <div class="col-3 col-sm-6"><img src="<c:url value='/resources/images/aroma/img38.gif'/>" width="100%" alt="온찜질"></div>
          ...
          <div class="col-3 col-sm-6"><img src="<c:url value='/resources/images/aroma/img39.gif'/>" width="100%" alt="마사지법"></div>
          <div class="col-13 col-sm-16">
          ...
          <div class="col-16">
              ...
              <div class="col-3 col-sm-6"><img src="<c:url value='/resources/images/aroma/img40.gif'/>" width="100%" alt="걸레" style="padding: 0 2em;"></div>
              <div class="col-13 col-sm-16">
          ...
          <div class="row">            
              <div class="col-3 col-sm-6"><img src="<c:url value='/resources/images/aroma/img41.gif'/>" width="100%" alt="청소기"></div>
              <div class="col-13 col-sm-16">
          ...
          <div class="row">       
              <div class="col-3 col-sm-6"><img src="<c:url value='/resources/images/aroma/img42.gif'/>" width="100%" alt="에어컨, 온풍기"></div>
              <div class="col-13 col-sm-16">
          ...
          <div class="row">            
              <div class="col-3 col-sm-6"><img src="<c:url value='/resources/images/aroma/img43.gif'/>" width="100%" alt="나무조각이나 숯"></div>
              <div class="col-13 col-sm-16">
          ...
          <div class="col-3 col-sm-6"><img src="<c:url value='/resources/images/aroma/img44.gif'/>" width="100%" alt="명함집, 지갑"></div>
          <div class="col-13 col-sm-16">
          ...
          <div class="row">
              <div class="col-3 col-sm-6"><img src="<c:url value='/resources/images/aroma/img45.gif'/>" width="100%" alt="옷장"></div>
              <div class="col-13 col-sm-16">
          ...
          <div class="row">
              <div class="col-3 col-sm-6"><img src="<c:url value='/resources/images/aroma/img46.gif'/>" width="100%" alt="세탁" style="padding: 0 3em"></div>
              <div class="col-13 col-sm-16">
          ...
          <div class="row">
              <div class="col-3 col-sm-6"><img src="<c:url value='/resources/images/aroma/img47.gif'/>" width="100%" alt="다리미질"></div>
              <div class="col-13 col-sm-16">
          ...
          <div class="row">
              <div class="col-3 col-sm-6"><img src="<c:url value='/resources/images/aroma/img48.gif'/>" width="100%" alt="생활 용품, 화장품" style="padding: 0 2em"></div>
              <div class="col-13 col-sm-16">
          ...
          <div class="col-3 col-sm-6"><img src="<c:url value='/resources/images/aroma/img49.gif'/>" width="100%" alt="생리대"></div>
          <div class="col-13 col-sm-16">
