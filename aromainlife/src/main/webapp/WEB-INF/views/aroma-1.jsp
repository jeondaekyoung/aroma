    ...
    <div class="detail-01">
      ...
      <div class="row tab-menu">
        <div class="col-12 prefix-2 suffix-2 text-center">
          <div class="fl w20"><a href="aroma-1.jsp" class="tab active">허브&amp;아로마테라피</a></div>
      ...
      <div class="row">
        <div class="col-12 prefix-2 suffix-2 aroma">
          ...
          <div class="col-3"><img src="images/aroma/men.gif" width="100%" alt="사람"></div>
          ...
          <div class="col-13">
            ...
            <div class="col-3">
                <img src="images/aroma/wallpaper.gif" width="100%" alt="이집트">
                <img src="images/aroma/spa.gif" width="100%" alt="그리스, 로마">
            </div>
            <div class="col-13">
          ...
          <div class="col-3">
            <img src="images/aroma/teacher.gif" width="100%" alt="학자">
          </div>
	    </div>
      </div>
      <!-- 끝: row-->
